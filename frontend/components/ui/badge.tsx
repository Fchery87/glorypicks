  ...
  'inline-flex items-center rounded-sm border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-accent-primary/50 focus:ring-offset-2 focus:ring-offset-bg-primary',
  {
    variants: {
      variant: {
        ...
        success:
          'border-transparent bg-accent-bullish/10 text-accent-bullish border-accent-bullish/30',
        bullish:
          'border-transparent bg-accent-bullish/10 text-accent-bullish border-accent-bullish/30',
        bearish:
          'border-transparent bg-accent-bearish/10 text-accent-bearish border-accent-bearish/30',
        destructive: 'border-transparent bg-error/10 text-error border-error/30',
