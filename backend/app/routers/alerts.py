...
async def create_alert(data: AlertCreate, user_id: str = Depends(get_session_id)) -> Alert:
    """
    Create a new alert.
...
async def list_alerts(
    symbol: str | None = None, user_id: str = Depends(get_session_id)
) -> list[Alert]:
    """
...
async def get_alert_history(
    limit: int = 100, user_id: str = Depends(get_session_id)
) -> list[AlertTriggered]:
    """
...
async def get_alert_stats(user_id: str = Depends(get_session_id)) -> AlertStats:
    """
...
async def get_alert(alert_id: str, user_id: str = Depends(get_session_id)) -> Alert:
...
async def update_alert(
    alert_id: str, data: AlertUpdate, user_id: str = Depends(get_session_id)
) -> Alert:
    """
...
async def delete_alert(alert_id: str, user_id: str = Depends(get_session_id)) -> None:
    """Delete an alert."""
...
async def reset_alert(alert_id: str, user_id: str = Depends(get_session_id)) -> Alert:
    """
